...
namespace QuanLyThuVien.Services
{
    public class MuonTraService
    {
            ...
            int soSachMuonMoi)
        {
            ...
            DateTime han =
                Convert.ToDateTime(the.Rows[0]["HanSuDung"]);

            bool lePhi =
                Convert.ToBoolean(the.Rows[0]["DaDongLePhi"]);
            ...
            decimal phiPhat)
        {
                   ...
                   cn.BeginTransaction(IsolationLevel.Serializable))
            {
                try
                {
                    ...
                    // Sách bình thường được trả về kho.
                    // Sách mất hoặc hư hỏng không tăng tồn kho.
                    if (!mat && !huHong)
                    {
